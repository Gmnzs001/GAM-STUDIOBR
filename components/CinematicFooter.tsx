          ...
          <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 mt-20 w-full max-w-5xl mx-auto">
            ...
            <div ref={linksRef} className="flex flex-col items-center gap-6 w-full">
              <div className="flex flex-wrap justify-center gap-4 w-full">
                ...
                <MagneticButton as="a" href="https://api.whatsapp.com/send/?phone=5562992589599&text=Olá, gostaria de fazer um orçamento!" target="_blank" className="footer-glass-pill px-10 py-5 rounded-full text-white font-bold text-sm flex items-center gap-3 bg-[#E02020]/20 border-[#E02020]/30">
